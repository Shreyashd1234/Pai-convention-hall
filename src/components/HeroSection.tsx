      ...
      <div className="relative z-20 flex flex-col items-center justify-center min-h-screen text-center text-white px-4">
        ...
        <div style={{ marginTop: '3cm' }}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 animate-slide-in justify-center items-center" style={{animationDelay: "0.3s"}}>
            <Button size="lg" className="bg-gold hover:bg-gold/90 text-white font-medium flex items-center gap-2 w-48 justify-center" asChild>
              <a href="tel:9591699558" className="flex items-center gap-2 w-full justify-center">
                <Phone className="w-5 h-5" />
                Call Now
              </a>
            </Button>
            <Button size="lg" className="bg-gold hover:bg-gold/90 text-white font-medium flex items-center gap-2 w-48 justify-center" asChild>
              <a href="https://wa.me/9591699558?text=Hi!%20I%20just%20visited%20your%20website%20and%20want%20to%20know%20more%20about%20Pai%20Convention%20Hall." target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 w-full justify-center">
